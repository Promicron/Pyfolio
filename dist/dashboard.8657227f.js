...
},{"base64-js":"Gvp3","ieee754":"jJYq","isarray":"pRlI","buffer":"wYDm"}],"xHy1":[function(require,module,exports) {
var define;
var global = arguments[3];
...
},{"buffer":"wYDm"}],"Vlbn":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.table = exports.getRecords = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            console.log(records); // records.forEach(record => (
            // ))
...
},{"airtable":"xHy1"}],"fKHr":[function(require,module,exports) {
"use strict";

var _base = require("./base.js");

var records = (0, _base.getRecords)();
console.log(records);
records.then(function (data) {
  var _data$3, _data$3$fields;

  document.querySelectorAll('.userName').forEach(function (item) {
    var _data$, _data$$fields;

    item.innerText = (_data$ = data[0]) === null || _data$ === void 0 ? void 0 : (_data$$fields = _data$.fields) === null || _data$$fields === void 0 ? void 0 : _data$$fields.Username;
  });
  document.querySelectorAll('.profession').forEach(function (item) {
    var _data$2, _data$2$fields;

    item.innerText = (_data$2 = data[0]) === null || _data$2 === void 0 ? void 0 : (_data$2$fields = _data$2.fields) === null || _data$2$fields === void 0 ? void 0 : _data$2$fields.Profession;
  });
  document.querySelector('.userAbout').innerText = (_data$3 = data[0]) === null || _data$3 === void 0 ? void 0 : (_data$3$fields = _data$3.fields) === null || _data$3$fields === void 0 ? void 0 : _data$3$fields.About;
});
},{"./base.js":"Vlbn"}]},{},["fKHr"], null)
//# sourceMappingURL=/dashboard.8657227f.js.map