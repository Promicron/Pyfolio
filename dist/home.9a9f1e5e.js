...
})({"6HPYv":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "318a30029a9f1e5e";
...
const getRecords = async ()=>{
    ...
    // ))
    document.querySelector("#userName").innerText = records[0].fields?.Username;
    document.querySelector("#profession").innerText = records[0].fields?.Profession;
    document.querySelector("#userAbout").innerText = records[0].fields?.About;
...
(function(f) {
    ...
    return (function() {
        ...
        2: [
            function(require, module, exports) {
                "use strict";
                var AirtableError1 = /** @class */ function() {
 ...
 */ function deprecate(fn, key, message) {
        ...
        9: [
            function(require, module, exports) {
                ...
                var HttpHeaders1 = /** @class */ function() {
            ...
            function(require, module, exports) {
                ...
                var AbortSignal1 = /*#__PURE__*/ function(_Emitter) {
                    ...
                    function AbortSignal() {
                        ...
                        if (!_this2.listeners) Emitter1.call(_assertThisInitialized(_this2));
...
//# sourceMappingURL=home.9a9f1e5e.js.map
